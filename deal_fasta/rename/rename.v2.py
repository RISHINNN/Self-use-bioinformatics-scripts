...
# 当前时间和用户信息
CURRENT_TIME = "2025-03-20 13:53:25"
CURRENT_USER = "ShrivatsaMehan"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        description='FASTA序列标识符重命名工具 - BioPython修改版\n' +
                    '1. 如未找到映射则保持原样不变\n' +
    ...
    for record in SeqIO.parse(args.fasta[0], 'fasta'):
        ...
        if original_id in id_map:
            ...
            # 构建新的描述: 新ID + 原ID + 原描述
            if full_desc:
                new_description = f"{new_id} {original_id} {full_desc}"
            else:
                new_description = f"{new_id} {original_id}"
